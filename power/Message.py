...
status_name_map = dict((eval(name), name) for name in ["S_IDLE", "S_PREPARING_TO_RECV", "S_READY_TO_RECV_ITEM", "S_RECVING", "S_RECVING", "S_WITH_ITEM", "S_TESTING", "S_READY_TO_SEND_ITEM", "S_SENDING", "S_BROKEN", "S_RESETTING", "S_UNKNOWN"])
